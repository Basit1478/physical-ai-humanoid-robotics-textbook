#!/usr/bin/env python3
"""
Script to batch ingest all documentation content into the Qdrant collection for the RAG chatbot.
This script reads all the markdown files from the docs directory and adds them to the Qdrant collection.
This version uses batch Cohere API calls for efficiency.
"""
...
async def main():
    """Main function to batch ingest all documentation content."""
    print("Starting batch documentation ingestion process...")
